...
<template>
  <div>
    ...
    <div
      v-if="open"
      ref="modal"
      class="pt-16 min-w-[90%] min-h-[50%] sm:min-w-[650px] sm:min-h-[400px] absolute top-[40%] sm:top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-20 bg-light-gray rounded-lg flex justify-center"
    >
      <div class="flex flex-col items-center text-white">
        ...
        <button
          class="text-white text-sm rounded py-[7px] sm:px-[125px] px-[25px] text-center bg-base-red mb-12"
          @click="handleSubmit"
        >
